...
The SDCPHomeAssistantConfigEntry type alias is used throughout the integration
...
type SDCPHomeAssistantConfigEntry = ConfigEntry[SDCPHomeAssistantData]


@dataclass
class SDCPHomeAssistantData:
    """Runtime data for sdcp config entries.

    Stored as entry.runtime_data after successful setup.
    Provides typed access to the API client and coordinator instances.
    """

    client: SDCPHomeAssistantApiClient
