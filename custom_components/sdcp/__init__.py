"""
Custom integration to integrate sdcp with Home Assistant.
...
https://github.com/apaperclip/hass-sdcp
...
if TYPE_CHECKING:
    ...
    from .data import SDCPHomeAssistantConfigEntry
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = SDCPHomeAssistantData(
        client=client,
        integration=async_get_loaded_integration(hass, entry.domain),
        coordinator=coordinator,
    )

    # Connect to projector before first refresh
