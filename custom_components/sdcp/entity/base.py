...
from custom_components.sdcp.const import ATTRIBUTION
...
class SDCPHomeAssistantEntity(CoordinatorEntity[SDCPHomeAssistantDataUpdateCoordinator]):
    """
    Base entity class for sdcp.
