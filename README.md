...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/apaperclip/hass-sdcp?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=hass-sdcp&category=integration)
...
1. Download the `custom_components/sdcp/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=sdcp)
...
1. Go to **Settings** → **Devices & Services**
2. Find **SDCP for Home Assistant**
...
Find all entities in **Settings** → **Devices & Services** → **SDCP for Home Assistant** → click on the device.
...
4. Check the integration diagnostics (Settings → Devices & Services → SDCP for Home Assistant → 3 dots → Download diagnostics)
