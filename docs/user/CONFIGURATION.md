...
This document describes all configuration options and settings available in the SDCP for Home Assistant custom integration.
...
```yaml
blueprint:
  name: SDCP for Home Assistant Alert
...
- [GitHub Issues](https://github.com/apaperclip/hass-sdcp/issues) - Report problems
