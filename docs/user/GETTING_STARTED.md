# Getting Started with SDCP for Home Assistant

This guide will help you install and set up the SDCP for Home Assistant custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/apaperclip/hass-sdcp`
6. Set category to "Integration"
7. Click "Add"
8. Find "SDCP for Home Assistant" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/apaperclip/hass-sdcp/releases)
2. Extract the `sdcp` folder from the archive
3. Copy it to `custom_components/sdcp/` in your Home Assistant configuration directory
...
4. Select entities from "SDCP for Home Assistant"

Example entities card:

```yaml
type: entities
title: SDCP for Home Assistant
entities:
...
- Report issues at [GitHub Issues](https://github.com/apaperclip/hass-sdcp/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/apaperclip/hass-sdcp/discussions)
