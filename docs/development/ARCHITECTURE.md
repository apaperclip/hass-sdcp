...
This document describes the technical architecture of the SDCP for Home Assistant custom component for Home Assistant.

## Directory Structure

```text
custom_components/sdcp/
...
│   ├── __init__.py          # Exports SDCPHomeAssistantDataUpdateCoordinator
...
│   ├── __init__.py          # Exports SDCPHomeAssistantEntity
...
- `base.py` - Main coordinator class (`SDCPHomeAssistantDataUpdateCoordinator`)
...
**Key class:** `SDCPHomeAssistantDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `SDCPHomeAssistantApiClient`
...
- `SDCPHomeAssistantConfigFlowHandler` (main flow)
- `SDCPHomeAssistantOptionsFlow` (options)
...
**Key class:** `SDCPHomeAssistantEntity` (in `entity/base.py`)
...
2. `SDCPHomeAssistantEntity` for common functionality
...
1. Create directory: `custom_components/sdcp/<platform>/`
2. Implement `__init__.py` with `async_setup_entry()`
3. Create entity classes inheriting from platform base + `SDCPHomeAssistantEntity`
