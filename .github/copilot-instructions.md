...
- **Main code:** `custom_components/sdcp/`
...
- `entity/` — Base entity class (`SDCPHomeAssistantEntity`)
...
- Entity MRO: `(PlatformEntity, SDCPHomeAssistantEntity)` — order matters
...
- Debug level: `custom_components.sdcp: debug` in `config/configuration.yaml`
