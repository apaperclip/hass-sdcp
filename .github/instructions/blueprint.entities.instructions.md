...
- **`entity/`** - Base entity classes (inherit `SDCPHomeAssistantEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, SDCPHomeAssistantEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import SDCPHomeAssistantEntity`
