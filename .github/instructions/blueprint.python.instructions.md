...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `SDCPHomeAssistant`
...
- Inherit from both platform entity and `SDCPHomeAssistantEntity` (order matters)
...
from custom_components.sdcp.sensor import async_setup_entry
...
**Config entry data:** `entry_data: SDCPHomeAssistantData = hass.data[DOMAIN][entry.entry_id]`
