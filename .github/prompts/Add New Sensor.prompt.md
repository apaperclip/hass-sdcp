...
- Create new sensor file in `custom_components/sdcp/sensor/`
- Inherit from `SDCPHomeAssistantEntity` and `SensorEntity`
...
```python
"""[Sensor description] for SDCP for Home Assistant."""
...
class SDCPHomeAssistant[SensorName]Sensor(
...
- Entity: `custom_components/sdcp/sensor/[sensor_name].py`
- Platform: `custom_components/sdcp/sensor/__init__.py`
- Translations: `custom_components/sdcp/translations/*.json`
