...
**File:** `custom_components/sdcp/services.yaml`
...
Create `custom_components/sdcp/service_actions/[action_name].py`:

```python
"""[Action name] service action for SDCP for Home Assistant."""
...
**File:** `custom_components/sdcp/__init__.py`
...
**File:** `custom_components/sdcp/const.py`
...
3. Find service action: `sdcp.[action_name]`
...
- **Domain:** `sdcp`
- **Service actions directory:** `custom_components/sdcp/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/sdcp/services.yaml` (legacy filename)
- **Icons:** `custom_components/sdcp/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/sdcp/translations/*.json` under `services` key (legacy)
