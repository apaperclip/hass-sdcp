...
**Directory:** `custom_components/sdcp/[platform]/`
...
```python
"""[Platform] platform for SDCP for Home Assistant."""
...
from .entity import SDCPHomeAssistantEntity
from .[entity_file] import SDCPHomeAssistant[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: SDCPHomeAssistantDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            SDCPHomeAssistant[EntityName](coordinator, entry),
...
```python
"""[Entity description] for SDCP for Home Assistant."""
...
class SDCPHomeAssistant[EntityName](
    SDCPHomeAssistantEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/sdcp/manifest.json`:
...
- [ ] Entity class inherits from both `SDCPHomeAssistantEntity` and platform class
...
- **Domain:** `sdcp`
- **Class prefix:** `SDCPHomeAssistant`
- **Base entity:** `SDCPHomeAssistantEntity` in `entity/base.py`
- **Coordinator:** `SDCPHomeAssistantDataUpdateCoordinator`
