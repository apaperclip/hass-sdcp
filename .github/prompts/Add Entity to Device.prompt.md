...
- Inherit from `SDCPHomeAssistantEntity` and platform base class
...
- Entity: `custom_components/sdcp/[platform]/[entity_name].py`
- Platform: `custom_components/sdcp/[platform]/__init__.py`
